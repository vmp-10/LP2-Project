...
public final class DebuggingManager {
    ...
    private static DebuggingManager instance; // Singleton instance
    private final Logger LOGGER;
    private Level level;

    // Private constructor to prevent direct instantiation
    public DebuggingManager() {
        this.LOGGER = Logger.getLogger(DebuggingManager.class.getName()); // Get a logger specific to the common.LoggingManager class
    ...
    public static DebuggingManager getInstance() {
        if (instance == null) {
            instance = new DebuggingManager(); // Create instance if not already created
        }
        return instance;
    }
